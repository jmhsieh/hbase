...
public class TestDistributedThreePhaseCommit {
  ...
  public void testMultiCohortWithMemberTimeoutDuringPrepare() throws Exception {
      ...
      Mockito.doAnswer(new Answer() {
        ...
        public Void answer(InvocationOnMock invocation) throws Throwable {
          ...
          if (index == memberErrorIndex) {
            ...
            Threads.waitForLatchUninterruptibly(coordinatorReceivedErrorLatch,
              new ExceptionSnare(),
    ...
    Threads.waitForLatchUninterruptibly(task.getCompletedLatch(), new ExceptionSnare<Exception>(),
      WAKE_FREQUENCY,
  ...
  private void waitAndVerifyTask(ThreePhaseCommit op, VerificationMode prepare,
      ...
      throws Exception {
    Threads.waitForLatchUninterruptibly(op.getCompletedLatch(), new ExceptionSnare<Exception>(),
