...
public interface CohortMemberTaskBuilder {
  ...
  /**
   * Build {@link TwoPhaseCommitable} operation when requested.
   * @param name name of the operation to start
   * @param data data passed from the coordinator about the operation
   * @return {@link TwoPhaseCommitable} to run or <tt>null</tt> if the no operation should be run
   ...
   */
  public <T extends ThreePhaseCommit> T buildNewOperation(
